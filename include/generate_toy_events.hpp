...
/// @brief Given a 'Histo1D' object, a PDF, and a TOTAL number of events to generate 'N', return toy data for each bin (poisson-generated)
...
void generate_toy_events(Histo1D& histogram, Fcn1D* PDF, double N, TRandom3& generator);
