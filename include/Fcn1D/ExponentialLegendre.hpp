#ifndef peak_search_ExponentialLegendre_hpp
#define peak_search_ExponentialLegendre_hpp
...
class ExponentialLegendre : public Fcn1D {
...
public: 
    ...
    ExponentialLegendre(const std::vector<double>& par={}, double x_min=-1., double x_max=+1.);

    //copy constructor 
    ExponentialLegendre(const ExponentialLegendre&) = default;
